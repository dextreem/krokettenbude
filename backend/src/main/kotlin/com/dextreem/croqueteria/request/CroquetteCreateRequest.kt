...
data class CroquetteCreateRequest(
    ...
    @field:Schema(description = "Name of the croquette", example = "Classic Jamón")
    var name: String,
    ...
    @field:Schema(description = "Detailed description of the croquette", example = "A delicious traditional croquette with ham and creamy béchamel.")
    var description: String,

    @field:Min(value = 1, message = "Crunchiness must be at least 1.")
    @field:Max(value = 5, message = "Crunchiness cannot exceed 5.")
    @field:Schema(description = "Crunchiness rating from 1 (soft) to 5 (very crunchy)", example = "4")
    var crunchiness: Int,

    @field:Min(value = 1, message = "Spiciness must be at least 1.")
    @field:Max(value = 5, message = "Spiciness cannot exceed 5.")
    @field:Schema(description = "Spiciness rating from 1 (mild) to 5 (very spicy)", example = "2")
    var spiciness: Int,

    @field:NotNull(message = "Vegan is mandatory")
    @field:Schema(description = "Is the croquette vegan?", example = "false")
    var vegan: Boolean,
    ...
    @field:Schema(description = "URL of the croquette image", example = "https://example.com/images/croquette.jpg")
    var imageUrl: String,
)
